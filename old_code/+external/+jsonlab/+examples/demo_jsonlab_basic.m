...
data2json=pi
external.jsonlab.savejson('',data2json)
json2data=external.jsonlab.loadjson(ans)
...
external.jsonlab.savejson('specials',data2json)
json2data=external.jsonlab.loadjson(ans)
...
external.jsonlab.savejson('sparse',data2json)
json2data=external.jsonlab.loadjson(ans)
...
external.jsonlab.savejson('complex_sparse',data2json)
json2data=external.jsonlab.loadjson(ans)
...
external.jsonlab.savejson('all_zero_sparse',data2json)
json2data=external.jsonlab.loadjson(ans)
...
data2json=sparse([]);
external.jsonlab.savejson('empty_sparse',data2json)
json2data=external.jsonlab.loadjson(ans)
...
data2json=[];
external.jsonlab.savejson('empty_0by0_real',data2json)
json2data=external.jsonlab.loadjson(ans)
...
data2json=zeros(0,3);
external.jsonlab.savejson('empty_0by3_real',data2json)
json2data=external.jsonlab.loadjson(ans)
...
external.jsonlab.savejson('sparse_column_vector',data2json)
json2data=external.jsonlab.loadjson(ans)
...
external.jsonlab.savejson('complex_sparse_column_vector',data2json)
json2data=external.jsonlab.loadjson(ans)
...
data2json=sparse([0,3,0,1,4]);
external.jsonlab.savejson('sparse_row_vector',data2json)
json2data=external.jsonlab.loadjson(ans)
...
data2json=data2json-1i*data2json;
external.jsonlab.savejson('complex_sparse_row_vector',data2json)
json2data=external.jsonlab.loadjson(ans)
...
external.jsonlab.savejson('astruct',data2json,struct('ParseLogical',1))
json2data=external.jsonlab.loadjson(ans)
...
external.jsonlab.savejson('Supreme Commander',data2json)
json2data=external.jsonlab.loadjson(ans)
...
external.jsonlab.savejson('debian',data2json,struct('FloatFormat','%.2f'))
json2data=external.jsonlab.loadjson(ans)
...
json2data=external.jsonlab.loadjson('{"ValidName":1, "_InvalidName":2, ":Field:":3, "项目":"绝密"}')
...
external.jsonlab.savejson('data2json',data2json)
json2data=external.jsonlab.loadjson(ans)  % only external.jsonlab.savejson works for cell arrays, external.jsonlab.loadjson has issues
