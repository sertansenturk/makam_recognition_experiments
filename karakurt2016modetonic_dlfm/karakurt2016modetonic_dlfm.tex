...
\maketitle
\begin{abstract}
Mode and tonic, in the general sense, defines the melodic framework and the reference tuning pitch for the melody in the performances of many music cultures. The mode and the tonic information of the audio recordings is essential for many music information retrieval tasks applied to these cultures such as automatic transcription, tuning analysis and music similarity and automatic description of digital music libraries. In this paper we present MORTY, an open source toolbox for mode recognition and tonic identification. The toolbox is implements a generalized variant of two state-of-the-art methods based on pitch distribution analysis. It is designed in a generic manner such that the algorithms can be easily optimized according to the culture-specific aspects of the studied music tradition. We test the generalized methodology systematically on a dataset of Ottoman-Turkish makam music composed of 1000 recordings in 50 makams and obtained XX\%, XX\% and XX\% accuracy in makam recognition, tonic recognition and joint estimation of the mode and tonic, respectively. We additionally present the experiments on Carnatic and Hindustani music in comparison with several methodologies recently proposed for raga/raag recognition and our preliminary experiments for mode recognition using neural networks. We hope that our toolbox would be used as a benchmark for future methodologies proposed for mode recognition and tonic identification, especially for music traditions in which these computational tasks have not been addressed yet.
