...
\keywords{Mode recognition; Tonic Identification; Toolbox; Ottoman-Turkish makam music; Carnatic Music; Hindustani Music; Pitch Class Distribution; $k$-nearest neighbors classification; Open Source Software; Reproducability}
...
\begin{figure}
\centering
\includegraphics[width=.9\columnwidth]{figures/bozkurt_pcd}
...
\begin{figure}
\centering
\includegraphics[width=.9\columnwidth]{figures/chordia_pcd}
